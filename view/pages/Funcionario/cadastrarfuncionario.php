      ...
      <div class="content">
        ...
        <form action="../../../model/Arquivo/Inicializacao/auth_process.php" id="sign-up-form" method="POST"
          ...
          <div class="form-input desativado">
            ...
            <input type="number" name="sign-up-codVet" id="sign-up-codVet"/>
          </div>
-->
          <!--Senha-->
          <div class="form-input desativado">
          ...
          <div class="form-input">
            ...
            <input type="text" name="sign-up-cpf" id="sign-up-cpf" placeholder="000.000.000-00" autocomplete="off"
              required />
          </div>
          ...
          <div class="form-input">
            ...
            <input type="text" name="sign-up-cep" id="sign-up-cep" placeholder="00000-000" autocomplete="off"
              required />
          </div>
          ...
          <div class="form-input">
            ...
            <input type="text" name="sign-up-rg" id="sign-up-rg" placeholder="00.000.000-0" autocomplete="off"
              required />
          </div>
          ...
          <div class="form-input">
            ...
            <input type="text" name="sign-up-tel" id="sign-up-tel" placeholder="(00) 00000-0000" autocomplete="off"
              required />
          </div>
